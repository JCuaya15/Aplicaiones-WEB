...
function main(opc){
    ...
    while(i <= 0){
        //1 esta crea el objeto la cambias por algo mas
        ...
        /***Asi puede precargar mas tarejtas para que funcione ***/
        /*
    ...
    switch(opc){
        case '1':
            //permite crear tus propias tarjetas dentro de la paguina
        ...
        case '2':
            //busca una tarjeta
            /***Busca e imprime los titulos de cada tarjeta***/
            ...
            /***Pide una tarjeta y muestra la tarjeta***/
            aux2 = (aux2*6)-6;
            //console.log(aux2);
            publi.lista[aux2+3]++;
